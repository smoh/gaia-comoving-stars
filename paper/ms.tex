...
\title{Widely separated, comoving stars in \textsl{Gaia DR1}}
...
those consistent with being drawn from the field population.  Although
we perform some visualizations using a (bias-corrected) inverse
parallax as a distance, the likelihood test works in the observable
space and uses the \gaia\ noise model responsibly.
% Results
