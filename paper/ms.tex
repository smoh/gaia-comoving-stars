...
are either remnants of a dispersing stellar system or are a widely-separated
binary star system. In either case, co-moving stars are of great interest for
studying chemical uniformity and star formation processes, the destruction of
star clusters and dwarf galaxies, and the tidal field and small-scale properties
of the mass distribution in the Milky Way. To date, thousands of candidate
co-moving star pairs have been identified by searching for stars with common
proper motions (\citealt{Luyten:1979,Poveda:1994,Allen:2000,Gould:2003,
Chaname:2004,Lepine:2007,Alonso-Floriano:2015}).
% Cite:
