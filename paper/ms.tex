...
\begin{itemize}
  \item We assume that the uncertainties in the data---parallax, $\varpi$, and
    ...
    % http://adsabs.harvard.edu/abs/2012A&A...538A..78L
...
signal-to-noise. \todo{(SMOH: still unsure about this)} 
...
slices of $\Delta v_t$ at 0.5, 5, and 9.5~\kms.
...
with high to low $\ln \mathcal{L}_1 /\mathcal{L}_2$ ratios.
...
Shown as gray shaded histogram, this distribution peaks at lower value ($\approx 2$),
