...
computed from this high-precision sample to emphasize the quality of the data.
...
\begin{figure*}[p]
  \begin{center}
    \includegraphics[width=\textwidth]{figures/hist_Nneighbors.pdf}
  \end{center}
  \caption{%
    Histogram of the number of co-moving neighbors to a star for varying
    degrees of contamination due to random pairs.
    \todo{SMOH: What is the optimal bins for this histogram to separate
    small number cases e.g., binary case (N=1) appropriately?}
