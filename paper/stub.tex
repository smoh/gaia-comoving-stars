...
\tablehead{\colhead{star1 source id} & \colhead{star2 source id} & \colhead{separation} & \colhead{$\ln \mathcal{L}_1 /\mathcal{L}_2$} & \colhead{ID$_\mathrm{network}$} & \colhead{$N_\mathrm{network}$}\\ \colhead{ } & \colhead{ } & \colhead{$\mathrm{pc}$} & \colhead{ } & \colhead{ } & \colhead{ }}
\startdata
